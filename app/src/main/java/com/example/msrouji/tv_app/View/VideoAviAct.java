...
public class VideoAviAct extends Activity implements IVLCVout.OnNewVideoLayoutListener {
    ...
    public final static String key_url = "sdsdkodspdsopdko";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vid_avi);
        ...
        url_video = getIntent().getStringExtra(key_url);
    }
    ...
    protected void onStart() {
        ...
        Media media = new Media(mLibVLC, Uri.parse(url_video));
