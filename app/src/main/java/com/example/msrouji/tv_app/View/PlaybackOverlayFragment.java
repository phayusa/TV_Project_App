...
public class PlaybackOverlayFragment extends android.support.v17.leanback.app.PlaybackOverlayFragment {
    ...
    private ArrayList<Stream> mItems = new ArrayList<Stream>();
    private int mCurrentItem;
    private Handler mHandler;
    private Runnable mRunnable;
    private Stream mSelectedMovie;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*for (int j = 0; j < movies.size(); j++) {
            ...
            if (mSelectedMovie.getName().contentEquals(movies.get(j).getTitle())) {
                mCurrentItem = j;
            }
        }*/
    ...
    private int getDuration() {
        Stream movie = mItems.get(mCurrentItem);
        MediaMetadataRetriever mmr = new MediaMetadataRetriever();
        //System.err.println("|"+movie.getUrl() +"|");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            mmr.setDataSource(movie.getUrl(), new HashMap<String, String>());
        } else {
            mmr.setDataSource(movie.getUrl());
        }
    ...
    private void updatePlaybackRow(int index) {
        if (mPlaybackControlsRow.getItem() != null) {
            //TODO modify
            Stream item = (Stream) mPlaybackControlsRow.getItem();
        ...
        try {
            ...
            //System.err.println(getDuration());
    ...
    public interface OnPlayPauseClickedListener {
        void onFragmentPlayPause(Stream movie, int position, Boolean playPause);
    }

    static class DescriptionPresenter extends AbstractDetailsDescriptionPresenter {
        @Override
        protected void onBindDescription(ViewHolder viewHolder, Object item) {
            viewHolder.getTitle().setText(((Stream) item).getName());
            // TODO to modify
            //viewHolder.getSubtitle().setText(((Stream) item).getStudio());
        }
    }
}
