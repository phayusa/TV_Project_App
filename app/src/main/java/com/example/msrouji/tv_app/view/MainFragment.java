...
public class MainFragment extends BrowseFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (getActivity().getClass().getSimpleName().equals("MainActivity")) {
            ...
            if (activity.getHeader_url() == null)
                ...
                if (activity.getTitle_view().equals("Séries"))
    ...
    private void loadDefaultRows() {
        ...
        HeaderItem gridHeaderCateg = new HeaderItem(0, "Choix");
        ...
        gridRowAdapterCateg.add("TV");
        gridRowAdapterCateg.add("Films");
        gridRowAdapterCateg.add("Séries");
        mRowsAdapter.add(new ListRow(gridHeaderCateg, gridRowAdapterCateg));


        HeaderItem gridHeader = new HeaderItem(1, getString(R.string.subscription_title));

        GridItemPresenter mGridPresenter = new GridItemPresenter(GRID_ITEM_WIDTH, GRID_ITEM_HEIGHT);
        ArrayObjectAdapter gridRowAdapter = new ArrayObjectAdapter(mGridPresenter);
        gridRowAdapter.add(getResources().getString(R.string.subscription_paid));
        gridRowAdapter.add(getResources().getString(R.string.subscription_time_left));
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
            ...
            if (item instanceof Stream) {
                ...
                switch (row.getHeaderItem().getName()) {
                    case "Abonnement":
                        switch (((String) item)) {
                            case "Souscrire 1 an supplémentaire":
                                Intent intent = new Intent(getActivity(), Paid_Activity.class);
                                startActivity(intent);
                                break;
                            default:
                                Intent intent2 = new Intent(getActivity(), SubscriptionActivity.class);
                    ...
                    case "Choix":
                        switch (((String) item)) {
                            case "Films":
                                ...
                                intent2.putExtra(MainActivity.key_extra_title, "Films");
                                startActivity(intent2);
                                break;
                            case "TV":
                            ...
                            case "Séries":
                                ...
                                intent_ser.putExtra(MainActivity.key_extra_title, "Séries");
                    ...
                    default:
                        ...
                        if (getTitle().equals("Films")) {
                            ...
                            //intent_chan.putExtra(GridActivity.keyType, true);
                        } else if (getTitle().equals("Séries")) {
